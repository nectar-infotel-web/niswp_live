...
<section id ="logosliders">
	<div class="container">
		<div class="row">
			<div id="Carousel2" class="carousel slide MultiCarousel-inner">
				<!-- Carousel items -->
				<div class="Carousel-inner">
					...
					while ( $loop->have_posts() ) : $loop->the_post(); 
						...
						if($i%5 == 0){ 
							...
							echo '<div class="spc carousel-item '.$active.'">';
							$j++;
						}?>
...
<section id="productslider">
	<div class="containerspec productslider_in">
		...
		<div id="Carousel" class="carousel slide products_slide ">
			...
			<div id="Carousel" class="carousel slide products_slide">
				...
				<div class="carousel-inner">
					...
					while ( $loop->have_posts() ) : $loop->the_post(); 
						...
						if($i%6 == 0 && $i != 0 ){ $spec_class="last_cls";}
						?>
						<div class="sliderouter <?php echo $spec_class; ?>">
							<div class="frameimg">
								<?php 
								$logo_link = get_post_meta( $post->ID, '_logoslider_meta_key', true );
								?>
			...
			<ol class="carousel-indicators pdtslider">
				<?php if($j > 0){  $i =0;
					while($j >=0){
						if($j == 0) { 
							$activeclass="active"; 
						}else  $activeclass ='';
						echo '<li data-target="#Carousel" class="'.$activeclass.'" data-slide-to="'.$i.'" ></li>';
						$j--;
						$i++;
					}
				}
	...
	<div class="container">
		...
		<div class="row techtitles_group">
			...
			while ( $techs->have_posts() ) : $techs->the_post(); 
				?>     
				<div class="col-md-3 col-sm-12 col-xs-12 technology_title">
					<h6><?php the_post_thumbnail(); ?>
					<span><?php the_title(); ?></span></h6>
				</div>
				<?php
			endwhile;
			wp_reset_postdata();
